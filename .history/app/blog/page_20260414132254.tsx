        ...
        >
          ...
          <button
            style={{
              ...
              boxShadow: showSocialMenu ? "0 8px 24px rgba(0,240,255,0.3)" : "none",
            }}
          >
          ...
          >
            ...
            <a
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.background = "rgba(59,89,152,0.3)";
            ...
            <a
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.transform = "scale(1.1)";
                e.currentTarget.style.boxShadow = "0 4px 16px rgba(225,48,108,0.4)";
              }}
              onMouseLeave={(e) => {
