        ...
        <div className="faq-container" style={{ width: "80%", maxWidth: "1400px", margin: "0 auto", padding: "0 clamp(16px,3vw,40px)", position: "relative", zIndex: 1 }}>
          ...
          <div className="faq-items" style={{ display: "flex", flexDirection: "column", gap: "40px" }}>
            {faqCategories.map((cat, catIdx) => (
              <div key={catIdx}>
                <h2 style={{ fontSize: "16px", fontWeight: 700, color: "#00f0ff", marginBottom: "14px", paddingBottom: "10px", borderBottom: "1px solid rgba(0,240,255,0.2)", textTransform: "uppercase", letterSpacing: "0.8px" }}>
                  {cat.category}
                </h2>
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          border: `1px solid ${expandedFAQ === key ? "rgba(0, 240, 255, 0.4)" : "rgba(0, 240, 255, 0.15)"}`,
                          borderRadius: "14px",
                          overflow: "hidden",
                      ...
                      >
                        <div style={{ padding: "20px 24px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                          ...
                          <svg
                            ...
                            strokeWidth="2"
                            style={{
                              transform: expandedFAQ === key ? "rotate(180deg)" : "rotate(0deg)",
