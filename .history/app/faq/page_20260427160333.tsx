        ...
        <div className="faq-container" style={{ width: "80%", maxWidth: "1400px", margin: "0 auto", padding: "0 clamp(16px,3vw,40px)", position: "relative", zIndex: 1 }}>
          ...
          <div style={{ maxWidth: "640px", margin: "0 auto 12px", position: "relative" }}>
            ...
            <input
              ...
              style={{ width: "100%", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(0,240,255,0.25)", borderRadius: "12px", padding: "14px 48px", fontSize: "15px", color: "#ffffff", outline: "none", boxSizing: "border-box", transition: "border-color 0.3s ease", position: "relative", zIndex: 2, pointerEvents: "auto" }}
