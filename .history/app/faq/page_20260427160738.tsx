...
export default function FAQ() {
  ...
  useEffect(() => {
    ...
    const cleanupOverlays = () => {
      try {
        // remove body class that mobile menu may leave behind
        document.body.classList.remove('mobile-menu-open');
        // re-enable pointer events on the FAQ container if something overlays it
        const container = document.querySelector('.faq-container') as HTMLElement | null;
        if (container) {
    ...
    document.addEventListener('visibilitychange', cleanupOverlays);

    return () => {
      window.removeEventListener('pageshow', cleanupOverlays);
      document.removeEventListener('visibilitychange', cleanupOverlays);
    };
  }, []);
  ...
  return (
    <div style={{ background: "#0a0a0a", minHeight: "100vh", color: "#ffffff" }}>
      ...
      <section style={{ paddingTop: "140px", paddingBottom: "100px", position: "relative", overflow: "hidden" }}>
        ...
        <div className="faq-container" style={{ width: "80%", maxWidth: "1400px", margin: "0 auto", padding: "0 clamp(16px,3vw,40px)", position: "relative", zIndex: 1100 }}>
          ...
          <div style={{ maxWidth: "640px", margin: "0 auto 12px", position: "relative" }}>
            ...
            <input
              ...
              style={{ width: "100%", background: "rgba(255,255,255,0.05)", border: "1px solid rgba(0,240,255,0.25)", borderRadius: "12px", padding: "14px 48px", fontSize: "15px", color: "#ffffff", outline: "none", boxSizing: "border-box", transition: "border-color 0.3s ease", position: "relative", zIndex: 1102, pointerEvents: "auto" }}
