...
export default function Home() {
  ...
  return (
    <div className="relative">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '30px', alignItems: 'stretch' }}>
            ...
            <div style={{ 
              ...
              <div style={{ marginBottom: '24px' }}>
                <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="#0f172a" strokeWidth="2">
                  <circle cx="12" cy="12" r="10"/>
                  <polyline points="12 6 12 12 16 14"/>
                </svg>
              </div>
              <h3 style={{ fontSize: '24px', fontWeight: 700, color: '#0f172a', marginBottom: '8px' }}>Standard</h3>
              <p style={{ color: '#64748b', fontSize: '14px', marginBottom: '24px' }}>Perfect for individual traders getting started</p>
              <div style={{ marginBottom: '24px' }}>
                <span style={{ fontSize: '14px', color: '#64748b' }}>₹</span>
                <span style={{ fontSize: '48px', fontWeight: 800, color: '#0f172a' }}>1,999</span>
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, flex: 1 }}>
                {[
                  ...
                  <li key={i} style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
                    ...
                    <span style={{ color: feature.included ? '#0f172a' : '#94a3b8', fontSize: '15px' }}>{feature.text}</span>
                  </li>
                ))}
              </ul>
            </div>
            ...
            <div style={{ 
              ...
              <h3 style={{ fontSize: '24px', fontWeight: 700, color: '#0f172a', marginBottom: '8px' }}>Premium</h3>
              <p style={{ color: '#64748b', fontSize: '14px', marginBottom: '24px' }}>For serious traders who want more power</p>
              <div style={{ marginBottom: '24px' }}>
                <span style={{ fontSize: '14px', color: '#64748b' }}>₹</span>
                <span style={{ fontSize: '48px', fontWeight: 800, color: '#0f172a' }}>4,999</span>
                <span style={{ fontSize: '16px', color: '#64748b' }}>/month</span>
              </div>
              <a href="https://app.uptrender.in/auth/register" style={{ 
                background: '#0f172a', 
            ...
            <div style={{ 
              ...
              <h3 style={{ fontSize: '24px', fontWeight: 700, color: '#0f172a', marginBottom: '8px' }}>Enterprise</h3>
              <p style={{ color: '#64748b', fontSize: '14px', marginBottom: '24px' }}>For professional traders and institutions</p>
              <div style={{ marginBottom: '24px' }}>
                <span style={{ fontSize: '14px', color: '#64748b' }}>₹</span>
                <span style={{ fontSize: '48px', fontWeight: 800, color: '#0f172a' }}>9,999</span>
                <span style={{ fontSize: '16px', color: '#64748b' }}>/month</span>
              </div>
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0, flex: 1 }}>
                {[
                  ...
                  <li key={i} style={{ display: 'flex', alignItems: 'center', gap: '12px', marginBottom: '16px' }}>
                    ...
                    <span style={{ color: '#0f172a', fontSize: '15px' }}>{feature.text}</span>
                  </li>
                ))}
              </ul>
            </div>
      ...
      {/* Footer */}
      <footer style={{ background: '#f8f9fa', color: '#374151', position: 'relative', zIndex: 12 }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '80px 60px 40px' }}>
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '80px', marginBottom: '60px' }}>
            {/* Column 1 - Company */}
            <div>
              <h3 style={{ fontSize: '18px', fontWeight: 700, marginBottom: '24px', color: '#374151' }}>Company</h3>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                {[
                  ...
                  <li key={i} style={{ marginBottom: '16px' }}>
                    <a href={item.href} style={{ color: '#64748b', textDecoration: 'none', fontSize: '16px', transition: 'color 0.2s' }}
            ...
            <div>
              <h3 style={{ fontSize: '18px', fontWeight: 700, marginBottom: '24px', color: '#374151' }}>Social Media</h3>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '16px' }}>
                  <a href="#" style={{ color: '#64748b', textDecoration: 'none', fontSize: '16px', display: 'flex', alignItems: 'center', gap: '12px', transition: 'color 0.2s' }}
                     onMouseEnter={(e) => e.currentTarget.style.color = '#0f172a'}
                     onMouseLeave={(e) => e.currentTarget.style.color = '#64748b'}>
            ...
            <div>
              <h3 style={{ fontSize: '18px', fontWeight: 700, marginBottom: '24px', color: '#374151' }}>Legal & Press</h3>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                {[
          ...
          <div style={{ borderTop: '1px solid #e5e7eb', paddingTop: '30px', textAlign: 'center' }}>
