...
export default function Home() {
  ...
  return (
    <div className="relative">
        ...
        <div className="everything-inner" style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 60px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '80px' }}>
          <div className="everything-content" style={{ flex: 1, maxWidth: '600px' }}>
            ...
            <p className="everything-subtitle" style={{ color: 'rgba(255, 255, 255, 0.7)', fontSize: '18px', lineHeight: 1.6, marginBottom: '48px', maxWidth: '500px', opacity: 0 }}>
              Now powered by India's smartest AI. Real-time market sentiment analysis. No-code strategy builder. Instant algo execution. Smart copy trading. All of it, right in your pocket. Trade smarter, faster, and 24/7 — whether you're at your desk or on the move.
            </p>
      ...
      <section ref={exploreRef} style={{ 
        ...
        <div style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 60px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '32px', marginBottom: '60px' }}>
            {/* Feature 1 - Unified Multi-Market Dashboard */}
            <div className="explore-step" style={{ 
              ...
              <p style={{ color: 'rgba(255, 255, 255, 0.7)', fontSize: '15px', lineHeight: 1.6 }}>
                Trade Forex & Crypto in one place. Monitor major Forex pairs and top Crypto assets side-by-side with real-time prices. Switch markets instantly without ever leaving the platform.
              </p>
            </div>

            {/* Feature 2 - No-Code AI Strategy Builder */}
            <div className="explore-step" style={{ 
              background: 'rgba(10, 15, 30, 0.6)', 
              border: '1px solid rgba(255, 255, 255, 0.1)', 
              borderRadius: '16px', 
              ...
              <p style={{ color: 'rgba(255, 255, 255, 0.7)', fontSize: '15px', lineHeight: 1.6 }}>
                Build winning strategies with simple prompts. Type what you want in plain English — our AI instantly creates, backtests, and refines the logic for you. From scalping XAUUSD to swing trading BTC.
              </p>
            </div>

            {/* Feature 3 - Smart AI Trade Assistant */}
            <div className="explore-step" style={{ 
              background: 'rgba(10, 15, 30, 0.6)', 
              border: '1px solid rgba(255, 255, 255, 0.1)', 
              borderRadius: '16px', 
              ...
              <p style={{ color: 'rgba(255, 255, 255, 0.7)', fontSize: '15px', lineHeight: 1.6 }}>
                Let AI do the heavy research for you. Pick any pair or coin and ask for market sentiment. Our AI scans thousands of global news sources, analyst reports, and on-chain data in seconds. Then it executes the trade exactly how you want.
              </p>
            </div>

            {/* Feature 4 - Advanced Backtesting Engine */}
            <div className="explore-step" style={{ 
              background: 'rgba(10, 15, 30, 0.6)', 
              border: '1px solid rgba(255, 255, 255, 0.1)', 
              borderRadius: '16px', 
              ...
              <p style={{ color: 'rgba(255, 255, 255, 0.7)', fontSize: '15px', lineHeight: 1.6 }}>
                Test before you risk. Run your strategies on years of real historical Forex and Crypto data. See win rate, drawdown, and profit exactly as it would perform live — before you put a single rupee on the line.
              </p>
            </div>

            {/* Feature 5 - Smart Copy Trading */}
            <div className="explore-step" style={{ 
              background: 'rgba(10, 15, 30, 0.6)', 
              border: '1px solid rgba(255, 255, 255, 0.1)', 
              borderRadius: '16px', 
              ...
              <p style={{ color: 'rgba(255, 255, 255, 0.7)', fontSize: '15px', lineHeight: 1.6 }}>
                Mirror expert trades with Master & Child accounts. Automatically copy trades from a Master Account into one or multiple Child Accounts in real time — with full control over risk and allocation.
              </p>
            </div>

            {/* Feature 6 - Real-Time Risk Management */}
            <div className="explore-step" style={{ 
              background: 'rgba(10, 15, 30, 0.6)', 
              border: '1px solid rgba(255, 255, 255, 0.1)', 
              borderRadius: '16px', 
              ...
              <p style={{ color: 'rgba(255, 255, 255, 0.7)', fontSize: '15px', lineHeight: 1.6 }}>
                Protect every trade automatically. Smart stop-loss, dynamic position sizing, trailing stops, and portfolio-wide risk limits — all running live across every Forex and Crypto position.
              </p>
            </div>

            {/* Feature 7 - Paper + Live Trading Suite */}
            <div className="explore-step" style={{ 
              background: 'rgba(10, 15, 30, 0.6)', 
              border: '1px solid rgba(255, 255, 255, 0.1)', 
              borderRadius: '16px', 
              ...
              <p style={{ color: 'rgba(255, 255, 255, 0.7)', fontSize: '15px', lineHeight: 1.6 }}>
                Practise risk-free, then go live in one click. Test everything in a full paper trading environment first. When you're ready, flip the switch to live trading with zero downtime.
              </p>
            </div>

            {/* Feature 8 - Secure Broker & Exchange Integration */}
            <div className="explore-step" style={{ 
              background: 'rgba(10, 15, 30, 0.6)', 
              border: '1px solid rgba(255, 255, 255, 0.1)', 
              borderRadius: '16px', 
              ...
              <h3 style={{ color: '#ffffff', fontSize: '22px', fontWeight: 700, marginBottom: '12px' }}>
                Secure Broker & Exchange Integration
              </h3>
              <p style={{ color: 'rgba(255, 255, 255, 0.7)', fontSize: '15px', lineHeight: 1.6 }}>
                Connect once. Trade everywhere. Seamless, bank-level secure API connection to your favourite Indian brokers, global Forex platforms, and leading Crypto exchanges. Your funds always stay in your own accounts.
              </p>
            </div>

            {/* Feature 9 - Strategy Marketplace */}
            <div className="explore-step" style={{ 
              background: 'rgba(10, 15, 30, 0.6)', 
              border: '1px solid rgba(255, 255, 255, 0.1)', 
              borderRadius: '16px', 
              ...
              <p style={{ color: 'rgba(255, 255, 255, 0.7)', fontSize: '15px', lineHeight: 1.6 }}>
                Buy, sell, or share proven strategies. Browse ready-made algo strategies from top Indian traders or publish your own. A complete marketplace built for Forex and Crypto — save time and discover what actually works.
              </p>
            </div>

            {/* Feature 10 - Secure Wallet & Instant Funding */}
            <div className="explore-step" style={{ 
              background: 'rgba(10, 15, 30, 0.6)', 
              border: '1px solid rgba(255, 255, 255, 0.1)', 
              borderRadius: '16px', 
              ...
              <h3 style={{ color: '#ffffff', fontSize: '22px', fontWeight: 700, marginBottom: '12px' }}>
                Secure Wallet & Instant Funding
              </h3>
              <p style={{ color: 'rgba(255, 255, 255, 0.7)', fontSize: '15px', lineHeight: 1.6 }}>
                Fund fast. Trade faster. Add money instantly via UPI, Razorpay, or crypto. Auto-deductions for strategies and trades. Clean, transparent, and fully secure.
              </p>
            </div>
          </div>
      ...
      {/* Footer */}
      <footer style={{ background: '#0a0a0a', color: '#9ca3af', position: 'relative', zIndex: 12 }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '80px 60px 60px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '60px', marginBottom: '48px', paddingTop: '48px', borderTop: '1px solid rgba(255, 255, 255, 0.1)' }}>
            ...
            <div>
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '12px' }}>
                  <a href="#" style={{ color: '#9ca3af', textDecoration: 'none', fontSize: '14px', display: 'flex', alignItems: 'center', gap: '10px', transition: 'color 0.2s' }}
                     onMouseEnter={(e) => e.currentTarget.style.color = '#00f0ff'}
                     onMouseLeave={(e) => e.currentTarget.style.color = '#9ca3af'}>
