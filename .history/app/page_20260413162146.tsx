    ...
    <div className="relative">
      ...
      <section ref={alwaysReadyRef} className="always-ready-section" style={{ background: '#0a0a0a', padding: '100px 0 80px', position: 'relative', zIndex: 12 }}>
        <div className="always-ready-inner" style={{ maxWidth: '1920px', margin: '0 auto', padding: '0 80px', textAlign: 'center' }}>
          {/* Header Row */}
          <div className="always-ready-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '40px', gap: '100px', position: 'relative', zIndex: 20, maxWidth: '1600px', margin: '0 auto 40px' }}>
            ...
            <p className="always-ready-subtitle" style={{ color: 'rgba(255, 255, 255, 0.7)', fontSize: '19px', lineHeight: 1.6, maxWidth: '550px', textAlign: 'left', opacity: 0, flex: '1 1 auto' }}>
          ...
          <div className="always-ready-laptop" style={{ position: 'relative', display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '800px', zIndex: 1, padding: '0 20px' }}>
            {/* MetaTrader 5 Label */}
