...
export default function Home() {
  ...
  useEffect(() => {
    if (videoRef.current) {
      ...
      const handleLoadedMetadata = () => {
        ...
        // Check if video has audio using a different method
  ...
  const toggleMute = () => {
    if (videoRef.current) {
      const video = videoRef.current;
      console.log("Toggle mute clicked. Current state - Muted:", isMuted);
      
      if (isMuted) {
        // Unmute: set muted to false, ensure volume is up, and play
        video.muted = false;
        video.volume = 1.0;
        console.log("Unmuting video. New muted state:", video.muted, "Volume:", video.volume);
    ...
    <div className="relative">
        ...
        <div className="everything-inner" style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 60px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '80px' }}>
          <div className="everything-content" style={{ flex: 1, maxWidth: '600px' }}>
            <h2 className="everything-title" style={{ color: '#ffffff', fontSize: '48px', fontWeight: 700, lineHeight: 1.1, marginBottom: '24px', opacity: 0 }}>
              Everything you need for profitable Forex & Crypto trading<span className="everything-dot" style={{ color: '#dc2626' }}>.</span>
            </h2>
      ...
      <section ref={servicesRef} className="services-stacking-section">
        <div className="services-stacking-container">
          ...
          <div className="stacking-cards-wrapper">
            ...
            <div className="stacking-card" style={{ '--card-index': 0 } as React.CSSProperties}>
              <div className="stacking-card-inner">
                <div className="stacking-card-image">
                  <div className="service-icon-wrapper" style={{ background: 'linear-gradient(135deg, #00f0ff20, #0080ff20)' }}>
                ...
                <div className="stacking-card-content">
                  ...
                  <p className="stacking-card-description">
                    Get real-time, AI-powered trading signals with precision accuracy. Our advanced algorithms analyze market patterns, sentiment, and technical indicators to deliver actionable insights that keep you ahead of market movements.
                  </p>
            ...
            <div className="stacking-card" style={{ '--card-index': 1 } as React.CSSProperties}>
              <div className="stacking-card-inner">
                <div className="stacking-card-image">
                  <div className="service-icon-wrapper" style={{ background: 'linear-gradient(135deg, #a855f720, #6366f120)' }}>
                    <svg width="80" height="80" viewBox="0 0 24 24" fill="none" stroke="#a855f7" strokeWidth="1.5">
                      <rect x="2" y="3" width="20" height="14" rx="2" ry="2"/>
                      <path d="M8 21h8M12 17v4M7 8h2M7 12h2M15 8h2M15 12h2M11 8h2v4h-2z"/>
                    </svg>
                  </div>
                </div>
                <div className="stacking-card-content">
                  ...
                  <p className="stacking-card-description">
                    Set your strategy and let our bots execute trades 24/7. Configure risk parameters, profit targets, and stop-losses while our system monitors markets around the clock, ensuring you never miss a profitable opportunity.
                  </p>
                  <button className="stacking-card-btn">
                    Read More
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <div className="stacking-card" style={{ '--card-index': 2 } as React.CSSProperties}>
              <div className="stacking-card-inner">
                <div className="stacking-card-image">
                  <div className="service-icon-wrapper" style={{ background: 'linear-gradient(135deg, #10b98120, #059d6920)' }}>
                    <svg width="80" height="80" viewBox="0 0 24 24" fill="none" stroke="#10b981" strokeWidth="1.5">
                      <path d="M21 12V7a2 2 0 0 0-2-2H5a2 2 0 0 0-2 2v10a2 2 0 0 0 2 2h7"/>
                      <path d="M16 19l2 2 4-4M12 11V8M8 11V8M16 11V8"/>
                    </svg>
                  </div>
                </div>
                <div className="stacking-card-content">
                  ...
                  <p className="stacking-card-description">
                    Track and optimize your entire portfolio with intelligent diversification tools. Get detailed analytics, performance metrics, and AI-driven recommendations to balance risk and maximize returns across all your assets.
                  </p>
                  <button className="stacking-card-btn">
                    Read More
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <div className="stacking-card" style={{ '--card-index': 3 } as React.CSSProperties}>
              <div className="stacking-card-inner">
                <div className="stacking-card-image">
                  <div className="service-icon-wrapper" style={{ background: 'linear-gradient(135deg, #f59e0b20, #d9770620)' }}>
                ...
                <div className="stacking-card-content">
                  ...
                  <p className="stacking-card-description">
                    Advanced risk assessment tools that analyze market volatility, position sizing, and exposure levels. Get comprehensive reports and alerts that help you make informed decisions while protecting your capital from unexpected downturns.
                  </p>
                  <button className="stacking-card-btn">
                    Read More
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <div className="stacking-card" style={{ '--card-index': 4 } as React.CSSProperties}>
              <div className="stacking-card-inner">
                <div className="stacking-card-image">
                  <div className="service-icon-wrapper" style={{ background: 'linear-gradient(135deg, #ef444420, #dc262620)' }}>
                ...
                <div className="stacking-card-content">
                  ...
                  <p className="stacking-card-description">
                    Deep dive into market trends with our comprehensive analytics dashboard. Access historical data, predictive models, and sentiment analysis to understand market dynamics and identify emerging opportunities before they become mainstream.
                  </p>
                  <button className="stacking-card-btn">
                    Read More
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            {/* Card 6 - Copy Trading */}
            <div className="stacking-card" style={{ '--card-index': 5 } as React.CSSProperties}>
              <div className="stacking-card-inner">
                <div className="stacking-card-image">
                  <div className="service-icon-wrapper" style={{ background: 'linear-gradient(135deg, #ec489920, #db277720)' }}>
                    <svg width="80" height="80" viewBox="0 0 24 24" fill="none" stroke="#ec4899" strokeWidth="1.5">
                ...
                <div className="stacking-card-content">
                  ...
                  <p className="stacking-card-description">
                    Follow and automatically replicate trades from top-performing traders. Browse through verified trader profiles, analyze their performance history, and allocate funds to mirror their strategies with customizable risk settings.
                  </p>
                  <button className="stacking-card-btn">
                    Read More
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <div className="stacking-card" style={{ '--card-index': 6 } as React.CSSProperties}>
              <div className="stacking-card-inner">
                <div className="stacking-card-image">
                  <div className="service-icon-wrapper" style={{ background: 'linear-gradient(135deg, #8b5cf620, #7c3aed20)' }}>
                    <svg width="80" height="80" viewBox="0 0 24 24" fill="none" stroke="#8b5cf6" strokeWidth="1.5">
                ...
                <div className="stacking-card-content">
                  ...
                  <p className="stacking-card-description">
                    Access a comprehensive library of trading courses, webinars, and tutorials. From beginner basics to advanced strategies, our expert-led content helps you continuously improve your trading skills and market knowledge.
                  </p>
                  <button className="stacking-card-btn">
                    Read More
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
            ...
            <div className="stacking-card" style={{ '--card-index': 7 } as React.CSSProperties}>
              <div className="stacking-card-inner">
                <div className="stacking-card-image">
                  <div className="service-icon-wrapper" style={{ background: 'linear-gradient(135deg, #06b6d420, #0891b220)' }}>
                ...
                <div className="stacking-card-content">
                  ...
                  <p className="stacking-card-description">
                    Round-the-clock assistance from our dedicated team of trading experts. Whether you need technical help, trading advice, or account support, our professional team is always ready to ensure your trading experience is seamless.
                  </p>
                  <button className="stacking-card-btn">
                    Read More
                    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <footer style={{ background: '#0a0a0a', color: '#9ca3af', position: 'relative', zIndex: 12, borderTop: '2px solid rgba(0, 240, 255, 0.3)' }}>
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '80px 60px 60px' }}>
          ...
          {/* Quick Links Grid */}
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '60px', marginBottom: '48px', paddingTop: '48px', borderTop: '1px solid rgba(255, 255, 255, 0.1)' }}>
            {/* Column 1 - Company */}
            <div>
