      ...
      <section ref={everythingSectionRef} className="everything-section" style={{ background: '#0a0a0a', padding: '100px 0' }}>
        <div className="everything-inner" style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 60px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '80px' }}>
          <div className="everything-content" style={{ flex: 1, maxWidth: '600px' }}>
            ...
            <p className="everything-subtitle" style={{ color: 'rgba(255, 255, 255, 0.7)', fontSize: '18px', lineHeight: 1.6, marginBottom: '24px', maxWidth: '500px', opacity: 0 }}>
            ...
            <a href="/about" className="read-more-link" style={{ display: 'inline-flex', alignItems: 'center', gap: '8px', color: '#00f0ff', fontSize: '16px', fontWeight: 600, textDecoration: 'none', marginBottom: '32px', opacity: 0, transition: 'all 0.3s ease' }}>
              Read More About Us
