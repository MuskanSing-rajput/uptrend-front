        ...
        <div className="everything-inner" style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 60px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '80px' }}>
          <div className="everything-content" style={{ flex: 1, maxWidth: '600px' }}>
            ...
            <div className="feature-cards" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px', marginBottom: '32px' }}>
              {/* Broker Integration */}
              <div className="feature-card" style={{ background: 'rgba(20, 20, 25, 0.8)', border: '1px solid rgba(0, 240, 255, 0.2)', borderRadius: '16px', padding: '24px', transition: 'all 0.3s ease', opacity: 0 }}>
