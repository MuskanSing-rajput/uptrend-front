    ...
    <div className="relative">
      ...
      <section ref={everythingSectionRef} className="everything-section" style={{ background: '#0a0a0a', padding: '100px 0' }}>
        <div className="everything-inner" style={{ maxWidth: '1400px', margin: '0 auto', padding: '0 60px', display: 'flex', alignItems: 'stretch', justifyContent: 'space-between', gap: '80px' }}>
          ...
          <div className="everything-phone" style={{ flex: 1, display: 'flex', justifyContent: 'center', alignItems: 'center', maxWidth: '700px' }}>
            <img src="/about.jpg" alt="Uptrender Trading App" className="phone-image" style={{ width: '100%', height: 'auto', maxWidth: '650px', objectFit: 'contain', opacity: 0 }} />
          </div>
        </div>
      </section>
