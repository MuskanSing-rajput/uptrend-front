      ...
      <section ref={alwaysReadyRef} className="always-ready-section" style={{ background: '#0a0a0a', padding: '100px 0 80px', position: 'relative', zIndex: 12 }}>
        <div className="always-ready-inner" style={{ maxWidth: '1920px', margin: '0 auto', padding: '0 80px', textAlign: 'center' }}>
          ...
          <div className="always-ready-laptop" style={{ position: 'relative', display: 'flex', justifyContent: 'center', alignItems: 'center', minHeight: '700px', zIndex: 1, padding: '0 20px', marginTop: '20px' }}>
            ...
            {/* AI Trade Label */}
            <div className="platform-label-gradient" style={{ position: 'absolute', top: '38%', right: '8%', background: 'rgba(192, 192, 192, 0.15)', backdropFilter: 'blur(10px)', border: '2px solid rgba(192, 192, 192, 0.5)', borderRadius: '14px', padding: '20px 44px', color: '#e5e5e5', fontSize: '24px', fontWeight: 700, zIndex: 10, cursor: 'pointer', transition: 'all 0.3s ease', boxShadow: '0 0 25px rgba(192, 192, 192, 0.3), 0 0 50px rgba(192, 192, 192, 0.15), inset 0 0 20px rgba(192, 192, 192, 0.08)', opacity: 0 }}>
              AI Trade
            </div>
