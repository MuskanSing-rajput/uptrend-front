  ...
  return (
    <div style={{ background: "#0a0a0a", minHeight: "100vh", color: "#ffffff" }}>
      <style>{`
        ...
        .feature-card, .benefit-item, .revenue-item, .cta-button {
      ...
      <section ref={heroRef} style={{ paddingTop: "140px", paddingBottom: "0px", position: "relative", overflow: "hidden" }}>
        <div style={{ position: "absolute", top: "-200px", left: "-200px", width: "600px", height: "600px", background: "radial-gradient(circle, rgba(168, 85, 247, 0.06) 0%, transparent 70%)", pointerEvents: "none" }} />
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 60px", position: "relative", zIndex: 1 }}>
          <h1 className="whitelabel-title" style={{ fontSize: "clamp(42px, 5vw, 72px)", fontWeight: 800, lineHeight: 1.05, marginBottom: "24px", opacity: 0 }}>
            White Label <span style={{ background: "linear-gradient(135deg, #a855f7, #ec4899)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Solutions</span><span style={{ color: "#a855f7" }}>.</span>
          </h1>
          ...
          <div className="whitelabel-content" style={{ opacity: 0, background: "linear-gradient(135deg, rgba(168, 85, 247, 0.08), rgba(236, 72, 153, 0.08))", border: "1px solid rgba(168, 85, 247, 0.2)", borderRadius: "24px", padding: "48px", marginTop: "48px" }}>
            <h2 style={{ fontSize: "28px", fontWeight: 700, marginBottom: "24px", color: "#a855f7" }}>Why Choose Uptrender White Label?</h2>
      ...
      <section ref={featuresRef} style={{ paddingTop: "60px", paddingBottom: "60px", position: "relative", overflow: "hidden", background: "linear-gradient(180deg, rgba(168, 85, 247, 0.02) 0%, rgba(236, 72, 153, 0.02) 100%)" }}>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 60px", position: "relative", zIndex: 1 }}>
          <h2 style={{ fontSize: "42px", fontWeight: 800, textAlign: "center", marginBottom: "50px", background: "linear-gradient(135deg, #a855f7, #ec4899)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
            What You Get
          </h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "28px" }}>
            {[
              ...
              <div key={i} className="feature-card" style={{
                ...
                <div style={{ marginBottom: "16px", display: "flex", justifyContent: "flex-start" }}><IconComponent size={40} color="#a855f7" strokeWidth={1.5} /></div>
                <h3 style={{ fontSize: "18px", fontWeight: 700, marginBottom: "12px", color: "#a855f7" }}>{item.title}</h3>
      ...
      <section ref={benefitsRef} style={{ paddingTop: "60px", paddingBottom: "60px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 60px", position: "relative", zIndex: 1 }}>
          <h2 style={{ fontSize: "42px", fontWeight: 800, marginBottom: "50px", background: "linear-gradient(135deg, #a855f7, #ec4899)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
            Powerful Features
          </h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "24px" }}>
            {[
              ...
              <div key={i} className="benefit-item" style={{
                ...
                <Check size={24} color="#a855f7" strokeWidth={2} style={{ flexShrink: 0, marginTop: "4px" }} />
                <div>
                  <h3 style={{ fontSize: "18px", fontWeight: 700, marginBottom: "8px", color: "#a855f7" }}>{item.title}</h3>
                  <p style={{ fontSize: "14px", color: "rgba(255, 255, 255, 0.6)", lineHeight: 1.6 }}>{item.description}</p>
                </div>
              </div>
            ))}
      ...
      <section ref={revenueRef} style={{ paddingTop: "60px", paddingBottom: "60px", position: "relative", overflow: "hidden", background: "linear-gradient(180deg, rgba(168, 85, 247, 0.05) 0%, rgba(236, 72, 153, 0.05) 100%)" }}>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 60px", position: "relative", zIndex: 1 }}>
          <h2 style={{ fontSize: "42px", fontWeight: 800, textAlign: "center", marginBottom: "16px", color: "#a855f7" }}>
            Built for Revenue
          </h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(280px, 1fr))", gap: "28px", marginBottom: "40px" }}>
            {[
              ...
              { title: "Trade Execution Charges", description: "Per-trade execution fees for your users" }
            ].map((item, i) => (
          ...
          <div style={{ background: "linear-gradient(135deg, rgba(168, 85, 247, 0.1), rgba(236, 72, 153, 0.1))", border: "1px solid rgba(168, 85, 247, 0.2)", borderRadius: "16px", padding: "32px", textAlign: "center" }}>
      ...
      <section ref={whyRef} style={{ paddingTop: "60px", paddingBottom: "60px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 60px", position: "relative", zIndex: 1 }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "28px" }}>
            {[
              ...
              <div key={i} style={{
                ...
                <Check size={24} color="#a855f7" strokeWidth={2} style={{ flexShrink: 0 }} />
                <div>
                  <h3 style={{ fontSize: "16px", fontWeight: 700, marginBottom: "8px", color: "#a855f7" }}>{item.title}</h3>
                  <p style={{ fontSize: "14px", color: "rgba(255, 255, 255, 0.6)", lineHeight: 1.6 }}>{item.description}</p>
                </div>
              </div>
            ))}
          ...
          <div style={{ marginTop: "50px", background: "linear-gradient(135deg, rgba(168, 85, 247, 0.1), rgba(236, 72, 153, 0.1))", border: "1px solid rgba(168, 85, 247, 0.2)", borderRadius: "16px", padding: "40px", textAlign: "center" }}>
            ...
            <p style={{ fontSize: "20px", fontWeight: 700, color: "#a855f7" }}>
      ...
      {/* CTA Section */}
      <section ref={ctaRef} style={{ paddingTop: "60px", paddingBottom: "60px", position: "relative", overflow: "hidden", background: "linear-gradient(180deg, rgba(168, 85, 247, 0.05) 0%, rgba(236, 72, 153, 0.05) 100%)" }}>
        <div style={{ position: "absolute", top: "-200px", left: "50%", transform: "translateX(-50%)", width: "800px", height: "800px", background: "radial-gradient(circle, rgba(168, 85, 247, 0.08) 0%, transparent 70%)", pointerEvents: "none" }} />
        
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 60px", position: "relative", zIndex: 1, textAlign: "center" }}>
          <h2 style={{ fontSize: "48px", fontWeight: 800, marginBottom: "24px", background: "linear-gradient(135deg, #a855f7, #ec4899)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
          ...
          <div style={{ display: "flex", gap: "24px", justifyContent: "center", flexWrap: "wrap" }}>
            <button
              ...
              onMouseEnter={(e) => {
                gsap.to(e.currentTarget, { scale: 1.05, boxShadow: "0 20px 40px rgba(168, 85, 247, 0.3)", duration: 0.3, overwrite: "auto" });
              }}
              onMouseLeave={(e) => {
                gsap.to(e.currentTarget, { scale: 1, boxShadow: "0 0px 0px rgba(168, 85, 247, 0)", duration: 0.3, overwrite: "auto" });
              }}
            >
              Schedule a Demo
            </button>
            <a href="/contact" className="cta-button" style={{
              ...
              gsap.to(e.currentTarget, { background: "rgba(168, 85, 247, 0.1)", borderColor: "rgba(168, 85, 247, 0.8)", scale: 1.05, duration: 0.3, overwrite: "auto" });
            }} onMouseLeave={(e) => {
              gsap.to(e.currentTarget, { background: "transparent", borderColor: "rgba(168, 85, 247, 0.4)", scale: 1, duration: 0.3, overwrite: "auto" });
            }}>
              Get Pricing Details
            </a>
          </div>
      ...
      {isDemoModalOpen && (
        <div style={{
          ...
          <div style={{
            ...
            <h2 style={{ fontSize: "32px", fontWeight: 800, marginBottom: "12px", background: "linear-gradient(135deg, #a855f7, #ec4899)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
              Schedule a Demo
            </h2>
            ...
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
              <div>
                <label style={{ display: "block", fontSize: "14px", fontWeight: 600, marginBottom: "8px", color: "#a855f7" }}>Name</label>
                <input
                  type="text"
                  name="name"
                  value={formData.name}
              ...
              <div>
                <label style={{ display: "block", fontSize: "14px", fontWeight: 600, marginBottom: "8px", color: "#a855f7" }}>Email</label>
                <input
                  type="email"
                  name="email"
              ...
              <div>
                <label style={{ display: "block", fontSize: "14px", fontWeight: 600, marginBottom: "8px", color: "#a855f7" }}>Phone</label>
                <input
                  type="tel"
                  name="phone"
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                <div>
                  <label style={{ display: "block", fontSize: "14px", fontWeight: 600, marginBottom: "8px", color: "#a855f7" }}>Preferred Date</label>
                  <input
                    type="date"
                    name="date"
                    value={formData.date}
                ...
                <div>
                  <label style={{ display: "block", fontSize: "14px", fontWeight: 600, marginBottom: "8px", color: "#a855f7" }}>Preferred Time</label>
                  <input
                    type="time"
                    name="time"
                    value={formData.time}
              ...
              <div>
                <label style={{ display: "block", fontSize: "14px", fontWeight: 600, marginBottom: "8px", color: "#a855f7" }}>Description (Optional)</label>
                <textarea
                  name="description"
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  ...
                  btn.style.boxShadow = "0 20px 40px rgba(168, 85, 247, 0.3)";
                }}
                onMouseLeave={(e) => {
                  const btn = e.currentTarget as HTMLButtonElement;
