...
export default function WhiteLabel() {
  ...
  useEffect(() => {
    if (!whatYouGetRef.current) return;
    const ctx = gsap.context(() => {
      gsap.fromTo(".what-you-get-title", 
        { opacity: 0, x: -80 }, 
        { opacity: 1, x: 0, duration: 1, ease: "power3.out", force3D: true, scrollTrigger: { trigger: ".what-you-get-title", start: "top 80%", end: "top 50%", toggleActions: "play none none reverse" } }
      );
    }, whatYouGetRef);
  ...
  return (
    <div style={{ background: "#0a0a0a", minHeight: "100vh", color: "#ffffff" }}>
      ...
      <section ref={heroRef} style={{ paddingTop: "140px", paddingBottom: "0px", position: "relative", overflow: "hidden" }}>
        <div style={{ position: "absolute", top: "-200px", left: "-200px", width: "600px", height: "600px", background: "radial-gradient(circle, rgba(0, 102, 255, 0.06) 0%, transparent 70%)", pointerEvents: "none" }} />
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 60px", position: "relative", zIndex: 1 }}>
          <h1 className="whitelabel-title" style={{ fontSize: "clamp(42px, 5vw, 72px)", fontWeight: 800, lineHeight: 1.05, marginBottom: "24px", opacity: 0 }}>
            White Label <span style={{ background: "linear-gradient(135deg, #0066ff, #00ccff)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>Solutions</span><span style={{ color: "#0066ff" }}>.</span>
          </h1>
          ...
          <div className="whitelabel-content" style={{ opacity: 0, background: "linear-gradient(135deg, rgba(0, 102, 255, 0.08), rgba(0, 204, 255, 0.08))", border: "1px solid rgba(0, 102, 255, 0.2)", borderRadius: "24px", padding: "48px", marginTop: "48px" }}>
            <h2 style={{ fontSize: "28px", fontWeight: 700, marginBottom: "24px", color: "#0066ff" }}>Why Choose Uptrender White Label?</h2>
      ...
      <section ref={whatYouGetRef} ref={featuresRef} style={{ paddingTop: "60px", paddingBottom: "60px", position: "relative", overflow: "hidden", background: "linear-gradient(180deg, rgba(0, 102, 255, 0.02) 0%, rgba(0, 204, 255, 0.02) 100%)" }}>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 60px", position: "relative", zIndex: 1 }}>
          <h2 className="what-you-get-title" style={{ fontSize: "42px", fontWeight: 800, textAlign: "center", marginBottom: "50px", background: "linear-gradient(135deg, #0066ff, #00ccff)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent", opacity: 0 }}>
            What You Get
          </h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "28px" }}>
            {[
              ...
              <div key={i} className="feature-card" style={{
                ...
                <div style={{ marginBottom: "16px", display: "flex", justifyContent: "flex-start" }}><IconComponent size={40} color="#0066ff" strokeWidth={1.5} /></div>
      ...
      <section ref={benefitsRef} style={{ paddingTop: "60px", paddingBottom: "60px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 60px", position: "relative", zIndex: 1 }}>
          <h2 style={{ fontSize: "42px", fontWeight: 800, marginBottom: "50px", background: "linear-gradient(135deg, #0066ff, #00ccff)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
            Powerful Features
          </h2>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr", gap: "24px" }}>
            {[
              ...
              <div key={i} className="benefit-item" style={{
                ...
                <Check size={24} color="#0066ff" strokeWidth={2} style={{ flexShrink: 0, marginTop: "4px" }} />
                <div>
                  <h3 style={{ fontSize: "18px", fontWeight: 700, marginBottom: "8px", color: "#0066ff" }}>{item.title}</h3>
                  <p style={{ fontSize: "14px", color: "rgba(255, 255, 255, 0.6)", lineHeight: 1.6 }}>{item.description}</p>
                </div>
              </div>
            ))}
