    ...
    <div className="relative">
          ...
          <div className="everything-content" style={{ flex: 1, maxWidth: '600px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
            ...
            <div className="everything-downloads" style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
              <div className="qr-code" style={{ display: 'flex', alignItems: 'center', gap: '16px' }}>
                <img src="/appqr.jpeg" alt="Scan to download Uptrender app" style={{ width: '100px', height: '100px', borderRadius: '8px', objectFit: 'cover' }} />
              ...
              <div className="store-buttons" style={{ display: 'flex', flexWrap: 'wrap', gap: '16px' }}>
                <a href="https://play.google.com/store/apps/details?id=com.uptrender12.uptrender" target="_blank" rel="noopener noreferrer" className="store-btn" style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 24px', background: '#1a1a1a', border: '1px solid rgba(255, 255, 255, 0.2)', borderRadius: '8px', textDecoration: 'none' }}>
                ...
                <a href="#" onClick={(e) => { e.preventDefault(); setShowComingSoon(true); }} className="store-btn" style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '12px 24px', background: '#1a1a1a', border: '1px solid rgba(255, 255, 255, 0.2)', borderRadius: '8px', textDecoration: 'none' }}>
                ...
                {/* APK button removed per request */}
              </div>
            </div>
          </div>
      ...
      {showComingSoon && (
        <div
          ...
          style={{ position: 'fixed', inset: 0, display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'rgba(0,0,0,0.6)', zIndex: 9999 }}
          onClick={() => setShowComingSoon(false)}
        >
          <div onClick={(e) => e.stopPropagation()} style={{ width: 'min(520px, 90%)', background: '#0b0b0f', borderRadius: 12, padding: '28px', boxShadow: '0 20px 60px rgba(0,0,0,0.6)', color: '#fff', textAlign: 'center' }}>
            <h3 style={{ margin: 0, fontSize: '20px', fontWeight: 800 }}>Coming soon on the App Store</h3>
            <p style={{ color: 'rgba(255,255,255,0.7)', marginTop: 12, marginBottom: 20 }}>We're preparing the Uptrender app for the App Store. We'll notify you when it's available.</p>
            <div style={{ display: 'flex', gap: 12, justifyContent: 'center' }}>
              <button onClick={() => setShowComingSoon(false)} style={{ padding: '10px 18px', borderRadius: 8, background: '#222', color: '#fff', border: '1px solid rgba(255,255,255,0.06)', fontWeight: 700 }}>Close</button>
            </div>
          </div>
        </div>
      )}
                ...
                {brokerLoop.map((broker, index) => (
                  <article
                    ...
                    onMouseEnter={e => {
                      ...
                      e.currentTarget.style.filter = 'drop-shadow(0 8px 20px rgba(0, 240, 255, 0.32))';
                    }}
                    onMouseLeave={e => {
