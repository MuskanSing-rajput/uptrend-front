    ...
    <div style={{ background: "#0a0a0a", minHeight: "100vh", color: "#ffffff" }}>
      ...
      <section ref={heroRef} style={{ paddingTop: "140px", paddingBottom: "0px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 60px", position: "relative", zIndex: 1 }}>
          <h1 className="partnership-title" style={{ fontSize: "clamp(42px, 5vw, 72px)", fontWeight: 800, lineHeight: 1.05, marginBottom: "24px", opacity: 0 }}>
          ...
          <p className="partnership-subtitle" style={{ fontSize: "20px", color: "rgba(255, 255, 255, 0.65)", maxWidth: "700px", lineHeight: 1.7, opacity: 0, marginBottom: "48px" }}>
          ...
          <div className="partnership-content" style={{ opacity: 0, background: "linear-gradient(135deg, rgba(0, 240, 255, 0.06), rgba(139, 92, 246, 0.06))", border: "1px solid rgba(0, 240, 255, 0.2)", borderRadius: "24px", padding: "48px", marginTop: "48px" }}>
      ...
      <section ref={franchiseRef} style={{ paddingTop: "60px", paddingBottom: "60px", position: "relative", overflow: "hidden" }}>
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 60px", position: "relative", zIndex: 1 }}>
          ...
          <div className="franchise-intro-box" style={{ opacity: 0, background: "linear-gradient(135deg, rgba(0, 240, 255, 0.08), rgba(139, 92, 246, 0.08))", border: "1px solid rgba(0, 240, 255, 0.2)", borderRadius: "24px", padding: "40px", marginBottom: "40px", perspective: "1000px" }}>
      ...
      {isModalOpen && (
        <div style={{
          ...
          <div style={{
            ...
            <h2 style={{ fontSize: "32px", fontWeight: 800, marginBottom: "12px", background: "linear-gradient(135deg, #00f0ff, #a855f7)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>
              Schedule a Demo
            </h2>
            ...
            <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
              {/* Name */}
              <div>
                <label style={{ display: "block", fontSize: "14px", fontWeight: 600, marginBottom: "8px", color: "#00f0ff" }}>Name</label>
                <input
                  type="text"
                  name="name"
                  value={formData.name}
              ...
              {/* Email */}
              <div>
                <label style={{ display: "block", fontSize: "14px", fontWeight: 600, marginBottom: "8px", color: "#00f0ff" }}>Email</label>
                <input
                  type="email"
                  name="email"
              ...
              {/* Phone */}
              <div>
                <label style={{ display: "block", fontSize: "14px", fontWeight: 600, marginBottom: "8px", color: "#00f0ff" }}>Phone</label>
                <input
                  type="tel"
                  name="phone"
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px" }}>
                {/* Date */}
                <div>
                  <label style={{ display: "block", fontSize: "14px", fontWeight: 600, marginBottom: "8px", color: "#00f0ff" }}>Preferred Date</label>
                  <input
                    type="date"
                    name="date"
                    value={formData.date}
                ...
                {/* Time */}
                <div>
                  <label style={{ display: "block", fontSize: "14px", fontWeight: 600, marginBottom: "8px", color: "#00f0ff" }}>Preferred Time</label>
                  <input
                    type="time"
                    name="time"
                    value={formData.time}
              ...
              {/* Description */}
              <div>
                <label style={{ display: "block", fontSize: "14px", fontWeight: 600, marginBottom: "8px", color: "#00f0ff" }}>Description (Optional)</label>
                <textarea
                  name="description"
              ...
              <button
                ...
                onMouseEnter={(e) => {
                  ...
                  btn.style.boxShadow = "0 20px 40px rgba(0, 240, 255, 0.3)";
                }}
                onMouseLeave={(e) => {
                  const btn = e.currentTarget as HTMLButtonElement;
